...
```bash
git clone https://github.com/rasifalsaif/equipFlow-project.git
cd equipFlow-project
```

### 2. Install dependencies

Install dependencies separately for the frontend and backend. It is recommended to use `pnpm` as the package manager.
